...
public PreparedSpatialStatement (PreparedStatement prepStmt) throws SQLException {
	...
	adapter = oracle.sdoapi.OraSpatialManager.getGeometryAdapter("SDO","8.1.6",null,oracle.sql.STRUCT.class,null,(oracle.jdbc.OracleConnection)s.getConnection());
}
	/**
	 * JDBC 2.0
	 *
	 ...
	 */
public void addBatch() throws SQLException {s.addBatch();}
	/**
	 * JDBC 2.0
	 *
	 ...
	 */
public void addBatch(String sql) throws SQLException {s.addBatch(sql);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void cancel() throws SQLException {s.cancel();}
	/**
	 * JDBC 2.0
	 *
	 ...
	 * driver does not support batch statements
	 */
public void clearBatch() throws SQLException {s.clearBatch();}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void clearParameters() throws SQLException {s.clearParameters();}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void clearWarnings() throws SQLException {s.clearWarnings();}
	/**
...
public int[] executeBatch() throws SQLException {
	 ...
	 *
	 * @return a SpatialResultSet that contains the data produced by the
	 * query; never null
	 * @exception SQLException if a database access error occurs
	 */
...
public int getQueryTimeout() throws SQLException {
	 ...
	 *
	 * @return the current result as a SpatialResultSet; null if the result
...
public SQLWarning getWarnings() throws SQLException {
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setArray(int i, Array x) throws SQLException {s.setArray(i,x);}
	/**
...
public void setBinaryStream(int parameterIndex, java.io.InputStream x, int length) throws SQLException {
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setBlob(int i, Blob x) throws SQLException {s.setBlob(i,x);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setBoolean(int parameterIndex, boolean x) throws SQLException {s.setBoolean(parameterIndex,x);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setByte(int parameterIndex, byte x) throws SQLException {s.setByte(parameterIndex,x);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setBytes(int parameterIndex, byte[] x) throws SQLException {s.setBytes(parameterIndex,x);}
	/**
	 * JDBC 2.0
	 *
...
public void setCharacterStream(int parameterIndex, java.io.Reader reader, int length) throws SQLException {
	 ...
	 * @exception SQLException if a database access, geometry or adapter error occurs
	 */
public void setCircle (int index, double x, double y, double radius) throws SQLException {
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setClob(int i, Clob x) throws SQLException {s.setClob(i,x);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setCursorName(String name) throws SQLException {s.setCursorName(name);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setDate(int parameterIndex, Date x) throws SQLException {s.setDate(parameterIndex,x);}
	/**
	 * JDBC 2.0
	 *
...
public void setDate(int parameterIndex, Date x, java.util.Calendar cal) throws SQLException {
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setDouble(int parameterIndex, double x) throws SQLException {s.setDouble(parameterIndex,x);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setEscapeProcessing(boolean enable) throws SQLException {s.setEscapeProcessing(enable);}
	/**
	 * JDBC 2.0
	 *
	 ...
	 */
public void setFetchDirection(int direction) throws SQLException {s.setFetchDirection(direction);}
	/**
	 * JDBC 2.0
	 *
	 ...
	 */
public void setFetchSize(int rows) throws SQLException {s.setFetchSize(rows);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setFloat(int parameterIndex, float x) throws SQLException {s.setFloat(parameterIndex,x);}
	/**
...
public void setGeometry (int index, Geometry geometry) throws SQLException {
	try {
		...
		s.setObject(index,adapter.exportGeometry(oracle.sql.STRUCT.class,geometry));
	}
	catch (InvalidGeometryException e) {
		throw new SQLException(e.toString());
	}
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setInt(int parameterIndex, int x) throws SQLException {s.setInt(parameterIndex,x);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setLong(int parameterIndex, long x) throws SQLException {s.setLong(parameterIndex,x);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setMaxFieldSize(int max) throws SQLException {s.setMaxFieldSize(max);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setMaxRows(int max) throws SQLException {s.setMaxRows(max);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setNull(int parameterIndex, int sqlType) throws SQLException {s.setNull(parameterIndex,sqlType);}
	/**
	 * JDBC 2.0
	 *
...
public void setPolygon (int index, double x[], double y[], int n) throws SQLException {
	...
	try {
		...
		Polygon polygon = gf.createPolygon(gf.createLineString(points),null);
...
public void setRectangle (int index, double xmin, double ymin, double xmax, double ymax) throws SQLException {
	try {
		Polygon rect = gf.createRectangle(Math.min(xmin,xmax),Math.min(ymin,ymax),
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setRef(int i, Ref x) throws SQLException {s.setRef(i,x);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setShort(int parameterIndex, short x) throws SQLException {s.setShort(parameterIndex,x);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setString(int parameterIndex, String x) throws SQLException {s.setString(parameterIndex,x);}
	/**
	 ...
	 * @exception SQLException if a database access error occurs
	 */
public void setTime(int parameterIndex, Time x) throws SQLException {s.setTime(parameterIndex,x);}
	/**
	 * JDBC 2.0
	 *
