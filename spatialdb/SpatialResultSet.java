...
public SpatialResultSet (ResultSet s, Connection con) {
	this.s = s;
	adapter = oracle.sdoapi.OraSpatialManager.getGeometryAdapter("SDO","8.1.6",oracle.sql.STRUCT.class,null,null,(oracle.jdbc.OracleConnection)con);
}
	/**
	 * JDBC 2.0
	 *
...
public boolean absolute(int row) throws SQLException {
	 ...
	 */
public void afterLast() throws SQLException {s.afterLast();}
	/**
	 * JDBC 2.0
	 *
	 ...
	 * result set type is TYPE_FORWARD_ONLY
	 */
public void beforeFirst() throws SQLException {s.beforeFirst();}
	/**
	 * JDBC 2.0
	 *
	 ...
	 *
	 */
public void cancelRowUpdates() throws SQLException {s.cancelRowUpdates();}
	/**
...
public void close() throws SQLException {s.close();}
	 ...
	 * called when on the insert row.
	 */
public void deleteRow() throws SQLException {s.deleteRow();}
	/**
...
public java.math.BigDecimal getBigDecimal(int columnIndex, int scale) throws SQLException {
	System.err.println("SpatialResultSet.getBigDecimal(int,int) is not implemented.");
	return null;
}
	/**
	 * JDBC 2.0
...
public Geometry getGeometry (int columnIndex) throws SQLException {
	try {
		oracle.sql.STRUCT dbObject = (oracle.sql.STRUCT)s.getObject(columnIndex);
		if (dbObject != null)
...
public Geometry getGeometry (String columnName) throws SQLException {
	try {
		oracle.sql.STRUCT dbObject = (oracle.sql.STRUCT)s.getObject(columnName);
		if (dbObject != null)
			return adapter.importGeometry(dbObject);
		else
			return null;
...
public java.net.URL getURL(String columnName) throws SQLException {
	System.err.println("SpatialResultSet.getURL(String) is not implemented.");
	return null;
}
	/**
...
public SQLWarning getWarnings() throws SQLException {
	 ...
	 */
public void insertRow() throws SQLException {s.insertRow();}
	/**
	 * JDBC 2.0
	 *
...
public boolean last() throws SQLException {
	 ...
	 */
public void moveToCurrentRow() throws SQLException {s.moveToCurrentRow();}
	/**
	 * JDBC 2.0
	 *
	 ...
	 * or the result set is not updatable
	 */
public void moveToInsertRow() throws SQLException {s.moveToInsertRow();}
/**
 * Constructor as static method.
 * @return the spatiotemporal result set (or null)
 * @param set the original result set (or null)
 * @param the database connection
 */
...
public boolean previous() throws SQLException {
	 ...
	 * called when on the insert row
	 */
public void refreshRow() throws SQLException {s.refreshRow();}
	/**
	 * JDBC 2.0
	 *
...
public void updateGeometry (int columnIndex, Geometry x) throws SQLException {
	try {
		s.updateObject(columnIndex,adapter.exportGeometry(oracle.sql.STRUCT.class,x));
	}
	catch (InvalidGeometryException e) {
		throw new SQLException(e.toString());
	}
	 ...
	 * @exception SQLException if an error occurs
	 */
public void updateGeometry (String columnName, Geometry x) throws SQLException {
	try {
		s.updateObject(columnName,adapter.exportGeometry(oracle.sql.STRUCT.class,x));
	}
	catch (InvalidGeometryException e) {
		throw new SQLException(e.toString());
	}
